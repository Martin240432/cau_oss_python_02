...
while True:
    ...
    if op == "end":
        ...
        num1 , num2 , ret = arithmetic_ops(add)     #[]의 사용가능기준? 함수 출력값을 넣을때는 쓰든 안쓰든 상관없는데 왜 함수 안에서는 사용 못함?
        #[num1 , num2 , ret] = arithmetic_ops(add) # 정의된 함수 사용      add
    elif op == "-":
        ...
        [num1 , num2 , ret] = arithmetic_ops(lambda x,y : x%y) # 익명함수(lambda) 사용       mod
    #
